...
public class ShowTutors extends javax.swing.JFrame {
    ...
    //This method populates the combobox with all Tutors
    public void populateComboBox () {
        ...
        jComboTutor.setModel(dblPopulateComboBox);
    }
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(jComboTutor, javax.swing.GroupLayout.PREFERRED_SIZE, 112, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void jButtonSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSubmitActionPerformed
        ...
        for (Tutor tutorlist: list) {
            if (tutorlist.toString().equals(jComboTutor.getSelectedItem().toString())){
                tutor = tutorlist;
            }
        }
       ...
       for (int i = 0; i < list.size(); i ++) {
           if (tutor.getID().equals(list.get(i).getID())) {
               new ShowIndividualTutor(i).setVisible(true);
               break;
           }
       }
        this.dispose();
